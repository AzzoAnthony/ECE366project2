...
### Contributions
- **Anthony** coded the Odd.asm program and uploaded the code to Github.
- **Mohamed** and **Alan** tested the coded and made sure the output is consistent.
- **Mohamed** and **Abdullah** contributed to the writing of the README report.
